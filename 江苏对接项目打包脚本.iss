...
#define MyAppName "HBPlatForm"
#define MyAppNameEn "HBPlatForm"
#define MyAppVersion "1.1.6.4"
#define MyAppPublisher "Tuners"
#define MyAppExeName "HBPlatForm.exe"
#define MyAppLoggingName "Tuners"
#define MyAppLoggedName "Tuners"
#define DebugSourcePath "..\..\Integration-platform-Docking-procedure-universal-version\trunk\GRPlatForm\bin\Debug"
#define ReleaseSourcePath "..\..\Integration-platform-Docking-procedure-universal-version\trunk\GRPlatForm\bin\Debug"

[Setup]
; NOTE: The value of AppId uniquely identifies this application.
; Do not use the same AppId value in installers for other applications.
; (To generate a new GUID, click Tools | Generate GUID inside the IDE.)
AppId={{10A81DBC-3CC1-487A-BA98-1343F6A0251E} 
AppName=" {#MyAppName} [{#MyAppVersion}] "
AppVersion={#MyAppVersion}
;AppVerName={#MyAppName} {#MyAppVersion}
AppPublisher={#MyAppPublisher}
DefaultDirName={pf}\{#MyAppNameEn}
DefaultGroupName=江苏平台对接系统
...
[Files]
Source: "{#ReleaseSourcePath}\HBPlatForm.exe"; DestDir: "{app}"; Flags: ignoreversion

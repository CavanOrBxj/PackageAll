...
#define MyAppName "EmergencyBroadcastingDockingPlatform"
#define MyAppNameEn "EmergencyBroadcastingDockingPlatform"
#define MyAppVersion "1.0.0.8"
#define MyAppPublisher "Tuners"
#define MyAppExeName "EmergencyBroadcastingDockingPlatform.exe"
#define MyAppLoggingName "Tuners"
#define MyAppLoggedName "Tuners"
#define DebugSourcePath "..\..\JiangsuNationStandardDockingPlatform\EmergencyBroadcastingDockingPlatform\EmergencyBroadcastingDockingPlatform\bin\Debug"
#define ReleaseSourcePath "..\..\JiangsuNationStandardDockingPlatform\EmergencyBroadcastingDockingPlatform\EmergencyBroadcastingDockingPlatform\bin\Debug"

[Setup]
; NOTE: The value of AppId uniquely identifies this application.
; Do not use the same AppId value in installers for other applications.
; (To generate a new GUID, click Tools | Generate GUID inside the IDE.)
AppId={{D400DD61-7B2D-4956-9DC5-881A92BEC0D1} 
AppName=" {#MyAppName} [{#MyAppVersion}] "
AppVersion={#MyAppVersion}
;AppVerName={#MyAppName} {#MyAppVersion}
AppPublisher={#MyAppPublisher}
DefaultDirName={pf}\{#MyAppNameEn}
DefaultGroupName=国标应急广播平台对接系统  
...
[Files]
Source: "{#ReleaseSourcePath}\EmergencyBroadcastingDockingPlatform.exe"; DestDir: "{app}"; Flags: ignoreversion
...
begin
    ResultCode:=-1;
    UnInstallFile:=''
    RegQueryStringValue(HKLM, 'SOFTWARE\Wow6432Node\Microsoft\Windows\CurrentVersion\Uninstall\{D400DD61-7B2D-4956-9DC5-881A92BEC0D1}_is1', 'UninstallString', UnInstallFile);
